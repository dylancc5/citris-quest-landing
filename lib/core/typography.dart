...
class AppTypography {
  ...
  static double getResponsiveSize(
    ...
    return calculatedSize < minimum ? minimum : calculatedSize;
  }
  ...
  static TextStyle largeTitle(
    ...
    final size = clampFontSize(
      (screenWidth * _largetitleFactor).clamp(_baseLargeTitle, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle title1(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _title1Factor).clamp(_baseTitle1, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle title2(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _title2Factor).clamp(_baseTitle2, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle title3(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _title3Factor).clamp(_baseTitle3, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle headline(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _headlineFactor).clamp(_baseHeadline, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle body(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _bodyFactor).clamp(_baseBody, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle callout(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _calloutFactor).clamp(_baseCallout, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle footnote(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _footnoteFactor).clamp(_baseFootnote, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle caption1(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _caption1Factor).clamp(_baseCaption1, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle caption2(
    ...
    final screenWidth = MediaQuery.of(context).size.width;
    final size = clampFontSize(
      (screenWidth * _caption2Factor).clamp(_baseCaption2, double.infinity),
    );
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle headingXL(
    ...
    final size = clampFontSize(screenWidth * 0.09);
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle headingM(
    ...
    final size = clampFontSize(screenWidth * 0.06);
    return _fontStyle(
      fontSize: size,
      color: color,
      fontWeight: fontWeight ?? FontWeight.w700,
  ...
  static TextStyle bodyL(
    ...
    final size = clampFontSize(screenWidth * 0.0590625);
    return _fontStyle(
      fontSize: size,
      color: color,
  ...
  static TextStyle buttonText(
    ...
    final size = clampFontSize(screenWidth * 0.0525);
    return _fontStyle(
      fontSize: size,
      color: color,
      fontWeight: fontWeight ?? FontWeight.w700,
